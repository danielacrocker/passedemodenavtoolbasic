    ...
    <v-flex xs4>
      <v-card>
        ...
        <div class="mx-auto" style="width: 200px">
          ...
          <!-- <v-btn class="card-title"  @click="rate">Rate this movie</v-btn> -->
          <!-- <v-btn class="card-title"  @click="console.log('you have clicked me')">Rate this movie</v-btn>  -->
        </div>
        <v-card-text>
          {{ movie.description }}
        </v-card-text>
